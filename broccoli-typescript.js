...
class BroccoliTypeScriptCompiler extends Plugin {
  constructor(inputPath, tsConfigPath, options) {
    ...
    // HACK: JASON
    console.log();
    console.log(chalk.black.bgYellow('BroccoliTypeScriptCompiler:'));
    console.log(chalk.green('  inputPath:'), '' + inputPath);
    console.log(chalk.green('  tsConfigPath:'), tsConfigPath);
